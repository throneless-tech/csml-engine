...
pub const RESERVED: &[&str] = &[
    ...
    SAY, SHOUT, WHISPER, DELETE, USE, HOLD, GOTO, MATCH, _METADATA, _MEMORY, _ENV, DEFAULT,
    REMEMBER, FORGET, TRUE, FALSE, NULL, BREAK, COMPONENT,
];

pub const UTILISATION_RESERVED: &[&str] = &[
    FOREACH, WHILE, IF, ELSE, IMPORT, CONST, INSERT, AS, DO, FLOW, STEP, SAY, SHOUT, WHISPER,
    DELETE, USE, HOLD, GOTO, MATCH, REMEMBER, FORGET, BREAK, COMPONENT,
];

pub const ASSIGNATION_RESERVED: &[&str] = &[
    FOREACH, WHILE, IF, ELSE, IMPORT, AS, DO, EVENT, FLOW, STEP, SAY, SHOUT, WHISPER, DELETE, USE,
    HOLD, GOTO, MATCH, REMEMBER, FORGET, _METADATA, _MEMORY, _ENV, TRUE, FALSE, NULL, BREAK,
    COMPONENT,
];
